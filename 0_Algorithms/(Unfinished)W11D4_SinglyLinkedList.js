...
class SinglyLinkedList {
    ...
    //         while(runner.next.data != val && runner.next) {
    //             runner = runner.next;
    //             nextCounter++;
    //         }
    ...
    //                 let appendedNodes = this.head;
    //                 let restOfNodes = runner.next.next;
    //                 while(nextCounter >= 0) {
    //                     appendedNodes = appendedNodes.next;
    //                     if(nextCounter == 0) {
    //                         appendedNodes = restOfNodes;
    //                     }
    //                     newHead.next = appendedNodes;
    //                     nextCounter--;
    //                 }
    //                 this.head = newHead;
...
console.log(emptyList.removeVal(15));
